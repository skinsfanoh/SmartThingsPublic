...
preferences {
    input("gourleyohio@gmail.com", "gourleyohio@gmail.com", title: "gourleyohio@gmail.com", description: "gourleyohio@gmail.com (usually an email address)")
    input("Nikki142*", "Nikki1432*", title: "Nikki1432*", description: "Your Nest password")
    input("09aa01ac441509vt", "text", title: "Serial #", description: "The serial number of your thermostat")
}
